# Metadaten & Thumbnails: Video 02

## Titel (Gewinner-Formel: Ort vorn + Jahr + AI-Label, ≤70 Z., kein Overclaim)
...
- Overclaim-Check: "Final 24 Hours" wird vom Skript exakt eingelöst
  (Morgen Tag 1 -> Morgen Tag 2). KEIN "hour by hour"-Versprechen.
...
3. **"Das Brot"** (Selektiv-Farb-Pop = Witness-Signatur, §11.3): fast
...
deliberate mistake. Can you find it? (First correct guess gets pinned.
...
· Sigurdsson et al., The Eruption of Vesuvius in AD 79
· M. Beard, Pompeii: The Life of a Roman Town
· A. Wallace-Hadrill, Herculaneum: Past and Future
· Cooley & Cooley, Pompeii and Herculaneum: A Sourcebook
Full source list → pinned comment.

All visuals are AI reconstructions based on historical sources. Some scenes
are artistic interpretations of documented events.
#history #pompeii #herculaneum #vesuvius #AIreconstruction #79AD #documentary
```

## Pinned Comment

Volle Quellenliste (inkl. Datums-Debatte-Studien + 2018-Graffito), Fehler-
Spiel-Regeln, Dank an V1-Voter mit Ergebnis-Zahlen, Frage: "Which detail
surprised you most — the floating stone, the snoring admiral, or the bread?"

## YouTube-Einstellungen

- Altered Content Flag: JA · Kategorie: Education · Sprache: EN
- Ende-Karte: Subscribe + [SIEGERSTADT]-Teaser ("NEXT WITNESS: [Variante]")
- Premiere: Sa 15:00 UTC mit 24h-Countdown (Rhythmus aus V01)

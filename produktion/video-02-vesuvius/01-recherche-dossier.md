...
| ~12:00–13:00 | **Plinian-Ausbruch beginnt**: Eruptionssäule wächst über Stunden von ~15 auf ~32 km (Carey & Sigurdsson 1987; Maximum erst in der Abendphase — im Skript als Progression erzählen, nicht als Sofort-Höhe). Plinius d. J. (17, in Misenum ~30 km): Wolke in Form einer **Schirmpinie** |
...
| ~Mitternacht–1 Uhr | **Säulenkollaps → erste pyroklastische Ströme (Surges S1–S2)**: treffen **Herculaneum** — ~400–500 °C, Tod in Sekundenbruchteilen. In den **Bootshäusern (Fornici) UND auf dem offenen Strand davor**: 300+ Skelette (erst ab 1982 entdeckt; Soldat + "Ring Lady" lagen am STRAND, nicht in den Bögen — im Skript "on the open beach and under the stone arches") |
...
- Karbonisierter Brotlaib aus der **Casa dei Cervi, Herculaneum** (Grabung 1930er),
  ...
  **Fundstelle Stempeltext: CIL X 8058,18** (Primärbeleg — der Stempel selbst
  ist die einzige harte Quelle zu Celer).
- Der Stempel diente der Zuordnung von Haushaltsbroten (Gemeinschaftsofen-
  Deutung). **Celer ist HAUSsklave des Granius-Verus-Haushalts — NICHT als
  "Bäcker" framen** (ob er selbst buk oder nur markierte, ist offen; Fundort
  ist das Wohnhaus, keine Bäckerei). Audit-Fix v2: Cold Open spielt in der
  Küche des Seefront-Hauses, nicht in einer Bäckerei.
- **Auflösungs-Fakt (Audit-präzisiert):** Ein "Q. Granius Verus" erscheint
  nach populärer Darstellung in den Herculaneum-Täfelchen/Album; die
  auffindbare Belegkette läuft über Popwissenschaft (Money 2018/Wikipedia),
  ein Primärbeleg (Camodeca, Tabulae Herculanenses; Wallace-Hadrill 2011,
  S. 242-244) wurde NICHT verifiziert. Deshalb: Im Skript trägt NUR S75 die
  Behauptung, gehedged ("some scholars read..."); S12 stützt sich allein auf
  den Stempel. Die Lesart "Celer wurde später freigelassen" bleibt Deutung,
  NIE Fakt. Ob Celer den Ausbruch überlebte, ist unbekannt — ehrlich so
  erzählen.
...
## Zitate — NUR BELEGTE WORTLAUTE (Fundstelle je Zitat)

1. (6.16, die Wolke — Radice) *"Its general appearance can best be expressed as
   being like an umbrella pine, for it rose to a great height on a sort of
   trunk and then split off into branches."*
2. (6.16.11, der Entschluss des Älteren — **LATEIN als Hauptzeile, Audit-Fix
   v2**): *"'Fortes' inquit 'fortuna iuvat: Pomponianum pete.'"* — Radice
   übersetzt diese Stelle NUR INDIREKT ("he refused, telling him that Fortune
   stood by the courageous and they must make for Pomponianus at Stabiae");
   die früher notierte direkte EN-Zeile ("Fortune favours the brave — head
   for Pomponianus") war eine Blog-Eigenübersetzung, fälschlich als Radice
   ausgewiesen. Regel: Karte zeigt Latein + eine ALS EIGENÜBERSETZUNG
   GEKENNZEICHNETE EN-Subline ("Fortune favours the brave — make for
   Pomponianus." / translation ours). Der "word for word"-Claim gilt nur
   fürs Latein.
3. (6.20, das Meer — Radice) *"We also saw the sea sucked away and apparently
   forced back by the earthquake: at any rate it receded from the shore."*
...
und referenziert im VO explizit Stabiae** · Tür vom Bims blockiert (6.16) ·
"anderswo längst Tag, hier tiefste Nacht" (6.16, Strand-Gang am Morgen von
Tag 2 — der Tod des Älteren fällt auf den Vormittag von Tag 2, zeitgleich
mit Pompejis Ende!) · Karren rollen auf ebener Straße (6.20) · Mutter-Szene
(6.20) · Asche "wie Schnee" (6.20) · "mehr schlafend als tot" (6.16).
...
- **Vesuv vor 79: EIN Kegel, grün, Weinberge bis hoch hinauf** — die heutige
  ...
  Die Römer wussten praktisch nicht, dass es ein Vulkan ist; Spartacus
  lagerte 73 v. Chr. im alten Krater. **Gelehrten-Ausnahmen (Audit-Fundstellen,
  Skript sagt deshalb "Almost no one" + Fußnoten-Bild):** Strabo, Geographica
  5.4.8 (gest. ~24 n. Chr., verbrannte Gipfelfelsen); vgl. Vitruv, De arch.
  2.6; Diodor 4.21. **Eruptions-Historie präzise:** letzter GROSSausbruch
  (plinianisch) = Avellino ~1900 v. Chr.; danach kleinere AP-Eruptionen
  (AP3–AP6, letzte ~3. Jh. v. Chr., evtl. 217 v. Chr., Stothers 2002 —
  umstritten). Im Skript NIE pauschal "schlief seit X" — nur den Großausbruch
  vor Roms Gründung datieren ("no one in living memory has seen it burn").
...
- Herculaneum-Kontrast: reicher, kleiner, am Meer; Holz/Lebensmittel/Schriftrollen
  karbonisiert erhalten (Villa dei Papiri); Skelette verteilt auf Fornici UND
  Strand — Soldat (Schwert, Werkzeug) und "Ring Lady" (Schmuck) lagen auf dem
  offenen Strand, Arzt-Besteck-Kasten bei den Funden.
...
- ❌ Tomaten, Mais, Kartoffeln, Kaffee, Orangen (Zitrone/Zitrusmedien nur als
  Citron-Fresko belegt — Markt-Zitrusfrüchte vermeiden), **Bananen (nicht auf
  römischen Märkten Italiens — Plinius kennt sie nur vom Hörensagen),
  Sonnenblumen, Kürbisse (Neue Welt)**, Papier-Bücher
